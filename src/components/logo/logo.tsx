...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const singleLogo = (
      ...
      >
        <img
          src={`${CONFIG.assetsDir}/logo/icononly_transparent_nobuffer.png`}
          alt="Logo"
          style={{ width: 'auto', height: '100%', margin: 'auto' }} // Adjust styles as necessary
        />
      </Box>
    );
    ...
    return (
      <Box
        ...
        sx={{
          ...baseSize,
          flexShrink: 0,
          display: 'inline-flex justify-center',
