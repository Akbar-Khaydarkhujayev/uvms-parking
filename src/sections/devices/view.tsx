...
import { Avatar, Button, Pagination, Stack, TextField, Typography } from '@mui/material';

import { useDebounce } from 'src/hooks/use-debounce';
import { useTranslate } from 'src/locales';
import { IDevice, useGetDevices } from './api/device/getList';
import { useBoolean } from 'src/hooks/use-boolean';
import { DeviceDialog, directions } from './components/DeviceDialog';
...
import { IDeviceUser, useGetDeviceUsers } from './api/deviceUser/deviceUsersList';
...
function UserRowItem({ row, setDeviceUser, openDeviceUserDialog }: UserRowItemProps) {
  const { t } = useTranslate();
  const popover = usePopover();
  const confirm = useBoolean();
